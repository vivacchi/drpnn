...
use spiking_brain::phase2_e::thermo_network::{ThermoNetwork, ThermoNetworkConfig};
...
fn main() {
    ...
    println!("== Phase 2 Fork E (過剰接続 12800本 plastic) ホワイトノイズ訓練版 ==");
    ...
    let mut csv_snap = File::create("phase2_e_whitenoise_snapshots.csv").expect("snap csv");
