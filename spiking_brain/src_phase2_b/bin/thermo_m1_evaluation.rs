...
use spiking_brain::phase2_b::thermo_network::{ThermoNetwork, ThermoNetworkConfig};
...
fn main() {
    ...
    println!("== Phase 2 Fork B (MATURATION_PERIOD=1000) ホワイトノイズ訓練版 ==");
    ...
    let mut csv_snap = File::create("phase2_b_whitenoise_snapshots.csv").expect("snap csv");
