...
use spiking_brain::phase2_a::thermo_network::{ThermoNetwork, ThermoNetworkConfig};
...
fn main() {
    ...
    println!("== Phase 2 Fork A (MIN_CONDUCTANCE=40) ホワイトノイズ訓練版 ==");
    ...
    let mut csv_snap = File::create("phase2_a_whitenoise_snapshots.csv").expect("snap csv");
